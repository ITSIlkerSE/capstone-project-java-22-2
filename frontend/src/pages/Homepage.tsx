...
export default function Homepage() {
    ...
    return (
        ...
        <div className="content home">
            <h2>Homepage</h2>
            <NavLink to={"/user/GenerateSetupPage"}>
                <button>Generate a setup</button>
            </NavLink>
            ...
            <NavLink to={"/user/CheckComponentsPage"}>
            ...
            <NavLink to={"/user/SetupCheckerPage"}>
                <button>Check a setup</button>
            </NavLink>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                 stroke="currentColor" className="w-6 h-6">
                <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 10.5L12 3m0 0l7.5 7.5M12 3v18"/>
            ...
            <NavLink to={"/user/ComputifyPcPage"}>
                <button>Computify</button>
            </NavLink>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                 stroke="currentColor" className="w-6 h-6">
                <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 10.5L12 3m0 0l7.5 7.5M12 3v18"/>
