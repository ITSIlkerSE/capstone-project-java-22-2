...
class CheckComputifyServiceTest {
    ...
    void addComponent_WithPostInputField_InFrontend() {
        ...
        //GIVEN
        Component component = new Component("1", "RTX 3080Ti", "Graphics cards", "High", 1000.00f, "2222-2222-2222", 879f);
        ComponentDTO componentDTO = new ComponentDTO("RTX 3080Ti", "Graphics cards", "High", 1000.00f, "2222-2222-2222", 879f);
    ...
    void getAllComponents_WhenGetAllRequestSend() {
        ...
        Component componentOne = new Component("1", "RTX 3080Ti", "Graphics cards", "High", 1000.00f, "2222-2222-2222", 879f);
        Component componentTwo = new Component("2", "RTX 3070Ti", "Graphics cards", "High", 1000.00f, "2222-2222-2222", 879f);
        Component componentThree = new Component("3", "RTX 3060Ti", "Graphics cards", "High", 1000.00f, "2222-2222-2222", 879f);
    ...
    void updateComponent_whenComponentAttributes_are_changed() {
        ...
        //GIVEN
        Component component1 = new Component("1", "RTX 3080Ti", "Graphics cards", "High", 1000.00f, "2222-2222-2222", 879f);
        ComponentDTO componentOne = new ComponentDTO("RTX 3080Ti", "Graphics cards", "High", 1000.00f, "2222-2222-2222", 879f);
